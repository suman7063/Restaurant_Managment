...
interface EditMenuCategoryModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const EditMenuCategoryModal: React.FC<EditMenuCategoryModalProps> = ({
  isOpen,
  onClose,
  onCategoryUpdated,
  category,
  ...
  return (
    <Modal 
      ...
      showFooter={true}
      cancelText="Cancel"
      actionText={isSubmitting ? "Updating..." : "Update Category"}
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {category.menu_items_count && category.menu_items_count > 0 && (
            <div className="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-lg text-sm">
              <strong>Note:</strong> This category contains {category.menu_items_count} menu item(s). 
              Making it inactive will hide these items from customers.
            </div>
          )}
