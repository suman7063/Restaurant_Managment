-- Complete UUID-based schema for Restaurant Management System
...
-- Create restaurants table with UUID primary key
...
-- Create menu_items table with UUID primary key
...
-- Create restaurant_tables table with UUID primary key
...
-- Create order_items table with UUID primary key
...
CREATE POLICY "Allow all operations on restaurants" ON restaurants FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations on menu_items" ON menu_items FOR ALL USING (true) WITH CHECK (true);
CREATE POLICY "Allow all operations on restaurant_tables" ON restaurant_tables FOR ALL USING (true) WITH CHECK (true);
